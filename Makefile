# Source: https://betterprogramming.pub/my-ultimate-makefile-for-golang-projects-fcc8ca20c9bb

GOCMD=go
GOTEST=$(GOCMD) test
GOVET=$(GOCMD) vet
BINARY_NAME=go-std-server
VERSION?=0.0.0
SERVICE_PORT?=3000
...
run: build ## Execute server binary with default arguments
	out/bin/${BINARY_NAME}
